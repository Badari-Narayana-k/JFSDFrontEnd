...
const CartDetails = () => {
    ...
    const makePayment = async()=>{
        const stripe = await loadStripe("pk_test_51O1DJ2SA1BRhSIDWUeRZU7FSrR97Z9wcODwjxF9kiASEBCkoZcBagdmQKsuJjqKnHDvAGG0TJJikd3ZKfCFGMTyZ0077NyPuuD");
        ...
        <>
            <div className='row justify-content-center m-0'>
                <div className='col-md-8 mt-5 mb-5 cardsdetails'>
                    <div className="lcard">
                        <div className="lcard-header bg-dark p-3">
                            <div className='lcard-header-flex'>
                                <h5 className='text-white m-0'>Cart Calculation{carts.length >0 ? `(${carts.length})`:""}</h5>
                                {
                                    carts.length > 0 ? <button className='btn lbtn-danger mt-0 btn-sm'
                                    onClick={emptycart}
                        ...
                        <div className="lcard-body p-0">
                                {
                                    carts.length === 0 ? <table className='ltable lcart-table mb-0'>
                                        <tbody>
                                            <tr>
                                                <td colSpan={6}>
                                                    <div className='lcart-empty'>
                                    ...
                                    <table className='ltable lcart-table mb-0 table-responsive-sm'>
                                        <thead>
                                            <tr>
                                                <th>Action</th>
                                                <th>Product</th>
